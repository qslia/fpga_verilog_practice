...
REM
REM Generated by Vivado on Sun Sep 07 13:47:19 +0800 2025
...
echo "xvlog --incr --relax -prj tb_or3_vlog.prj"
call xvlog  --incr --relax -prj tb_or3_vlog.prj -log xvlog.log
